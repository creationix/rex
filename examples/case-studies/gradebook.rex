...
// rex examples/case-studies/gradebook.rex

// Some config options can be passed in via the CLI
// So we need to define them here so the CLI knows what inputs this script supports
// This will enable auto-complete and type checking for these variables
extern pass-threshold: int | none
extern max-grade: int | none

// This should infer type integer without none
